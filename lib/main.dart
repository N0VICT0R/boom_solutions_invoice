...
import 'package:boom_solutions_invoice/services/location_tracker.dart'; // This should import LocationTrackerController
...
void main() async {
  ...
  // Register LocationTrackerController (not LocationTracker)
  ...
  locationTracker.setApiToken('gln5EU3jkGwBy7GZWnSpm9N7EffslYS5'); // Your API token
  // Note: No need to call initialize() as it's already called in onInit()
