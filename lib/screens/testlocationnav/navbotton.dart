...
//         Uri.parse('$baseUrl/api/v1/partners/map?api_token=$token&search&state_id&limit'),
//       );
...
//         if (data['success']) {
//           setState(() {
//             _partners = (data['partners'] as List)
...
//                   subtitle: Text(
//                     '${partner.address.isNotEmpty ? partner.address : 'No address'}\n'
